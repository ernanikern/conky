...
clock_h = {
    ...
    txt_fg_colour=0xFFFFFF,        txt_fg_alpha=1.6,
    graduation_radius=84,
    graduation_thickness=6,        graduation_mark_thickness=2,
    graduation_unit_angle=30,
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=1.3,
    },
}
-- MINUTES
clock_m = {
...
},
{
    ...
    txt_fg_colour=0xEF5A29,        txt_fg_alpha=1.0,
    graduation_radius=28,
    graduation_thickness=0,        graduation_mark_thickness=1,9
    graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.3,
    caption='',
    caption_weight=1,              caption_size=8.0,
...
{
    name='fs_used_perc',           arg='/media/HDD1',                max_value=100,
    x=85,                          y=400,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/media/HDD2',                max_value=100,
    x=85,                          y=400,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
